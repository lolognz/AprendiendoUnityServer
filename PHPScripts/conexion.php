...
$usuario = "adminUnity"; //El usuario que acabamos de crear en la base de datos
$contrasenha = "admin"; //La contraseña del usuario que utilizaremos
$BD = "pruebasunity"; //El nombre de la base de datos
 
